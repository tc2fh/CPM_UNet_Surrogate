...
train script residual periodic u net with 2 loss terms in the loss function
non-recursive training
...
class LitDataModule(pl.LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        train_dataset = CustomZarrDataset(
